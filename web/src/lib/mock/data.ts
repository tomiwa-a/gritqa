...
export const projects: Project[] = [
  ...
  },
  {
    ...
    lastIndexedAt: atOrNull('4mo ago'),
    fileCount: 9,
    endpointCount: 11,
  },
];
...
export const rules: TestingRule[] = [
  {
    ...
    category: 'ordering',
    isActive: true,
    detail: 'priority 1 — test authentication before other endpoints',
  },
  {
    publicId: 'tr_2',
    name: 'Create before read',
    category: 'ordering',
    isActive: true,
    detail: 'priority 2 — never assert on a list before seeding it',
  },
  {
    publicId: 'tr_3',
    ...
    category: 'ordering',
    isActive: true,
    detail: 'priority 9 — deletes go at the end of a plan',
  },
  {
    publicId: 'tr_4',
    ...
    category: 'mock',
    isActive: true,
    detail: 'target paystack — 200, status success, amount 10000',
  },
  {
    publicId: 'tr_5',
    ...
    category: 'mock',
    isActive: true,
    detail: 'target paystack — /transaction/verify returns success',
  },
  {
    publicId: 'tr_6',
    name: 'Stripe webhook',
    category: 'mock',
    isActive: true,
    detail: 'target stripe — signed event, 200',
  },
  {
    publicId: 'tr_7',
    name: 'Outbound mail',
    category: 'mock',
    isActive: true,
    detail: 'target sendgrid — 202, no delivery',
  },
  {
    publicId: 'tr_8',
    name: 'Object storage',
    category: 'mock',
    isActive: false,
    detail: 'target s3 — 200, fake object key',
  },
  {
    publicId: 'tr_9',
    ...
    category: 'assertion',
    isActive: true,
    detail: 'responseTime lt 2000 on every step',
  },
  {
    publicId: 'tr_10',
    name: 'Never a 500',
    category: 'assertion',
    isActive: true,
    detail: 'status notEquals 500 on every step',
  },
  {
    publicId: 'tr_11',
    ...
    category: 'assertion',
    isActive: true,
    detail: 'header content-type contains application/json',
  },
  {
    publicId: 'tr_12',
    ...
    category: 'assertion',
    isActive: true,
    detail: 'bodyField error notContains goroutine',
  },
  {
    publicId: 'tr_13',
    ...
    category: 'assertion',
    isActive: true,
    detail: 'unauthenticated calls assert status equals 401',
  },
  {
    publicId: 'tr_14',
    ...
    category: 'assertion',
    isActive: false,
    detail: 'bodyField meta.total exists on list endpoints',
  },
  {
    publicId: 'tr_15',
    name: 'Test email',
    category: 'fixture',
    isActive: true,
    detail: 'testEmail — qa+run@gritqa.dev',
  },
  {
    publicId: 'tr_16',
    name: 'Test password',
    category: 'fixture',
    isActive: true,
    detail: 'testPassword — generated per run',
  },
  {
    publicId: 'tr_17',
    name: 'Test amount',
    category: 'fixture',
    isActive: true,
    detail: 'testAmount — 50000 minor units',
  },
  {
    publicId: 'tr_18',
    name: 'Test currency',
...
export const coverageTotals = coverage
  ...
  .reduce((acc, e) => ({ ...acc, [e.state]: acc[e.state] + 1, total: acc.total + 1 }), {
    approved: 0,
    draft: 0,
    failing: 0,
    none: 0,
...
export const auditLog: AuditEntry[] = [
  {
    ...
    label: 'payments-api re-read after a push to main',
    tone: 'project',
    whenLabel: '4m ago',
    createdAt: at('4m ago'),
    ip: '102.89.34.7',
  },
  {
    ...
    label: 'Charge a checkout with a mocked provider failed on step 4',
    tone: 'run',
    whenLabel: '12m ago',
    createdAt: at('12m ago'),
    ip: '102.89.34.7',
  },
  {
    id: 8419,
    action: 'test_plan.created',
    label: 'Checkout applies the right tax rate drafted from a push',
    tone: 'plan',
    whenLabel: '2h ago',
    createdAt: at('2h ago'),
    ip: '102.89.34.7',
  },
  {
    ...
    label: 'Webhook replay is idempotent approved by you',
    tone: 'plan',
    whenLabel: '3h ago',
    createdAt: at('3h ago'),
    ip: '102.89.34.7',
  },
  {
    ...
    label: 'Pagination envelope turned off',
    tone: 'rule',
    whenLabel: 'Yesterday',
    createdAt: at('Yesterday'),
    ip: '102.89.34.7',
  ...
  {
    id: 8416,
    action: 'mock_endpoint.created',
    label: 'Stripe webhook mock added',
    tone: 'rule',
    whenLabel: 'Yesterday',
    createdAt: at('Yesterday'),
    ip: '102.89.34.7',
  ...
  },
  {
    ...
    label: 'notifications added from the CLI',
    tone: 'project',
    whenLabel: '5d ago',
    createdAt: at('5d ago'),
    ip: '41.58.120.19',
